...
class JElementAuthor extends JElement
{
	...
	function fetchElement($name, $value, &$node, $control_name)
	{
		...
		// Include user in groups that have access to edit their articles, other articles, or manage swaplocal.
		$action = array('com_swaplocal.article.edit_own', 'com_swaplocal.article.edit_article', 'com_swaplocal.manage');
