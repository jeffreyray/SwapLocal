<?php
/**
 * @version		$Id: currencies.php 22355 2011-11-07 05:11:58Z github_bot $
...
class SwapLocalModelCurrencies extends JModelList
{
	...
	protected function getListQuery()
	{
		...
		$query->from('#__swaplocal_currencies AS a');
	...
	public function getAuthors() {
		...
		$query->join('INNER', '#__swaplocal_currencies AS c ON c.created_by = u.id');
		$query->group('u.id');
		$query->order('u.name');
	...
	/**
	 * Method to get a list of currencies.
	...
	public function getItems()
	{
		...
		if ($app->isSite()) {
			...
			for ($x = 0, $count = count($items); $x < $count; $x++) {
				//Check the access level. Remove currencies the user shouldn't see
