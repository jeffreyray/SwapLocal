 ...
 */
class SwapLocalModelFeatured extends SwapLocalModelArticles
{
	/**
	 * Constructor.
	 *
	...
	function getListQuery($resolveFKs = true)
	{
		...
		// Join over the swaplocal table.
		$query->select('fp.ordering');
		$query->join('INNER', '#__swaplocal_frontpage AS fp ON fp.swaplocal_id = a.id');
