...
class SwapLocalViewCurrency extends JView
{
	...
	protected function addToolBar() 
	{
		...
		JToolBarHelper::title($isNew ? JText::_('COM_SWAPLOCAL_MANAGER_CURRENCY_NEW') : JText::_('COM_SWAPLOCAL_MANAGER_CURRENCY_EDIT'), 'swaplocal');
	...
	protected function setDocument() 
	{
		...
		$document->setTitle($isNew ? JText::_('COM_SWAPLOCAL_CURRENCY_CREATING') : JText::_('COM_SWAPLOCAL_CURRENCY_EDITING'));
		$document->addScript(JURI::root() . $this->script);
		$document->addScript(JURI::root() . "/administrator/components/com_swaplocal/views/currency/submitbutton.js");
		JText::script('COM_SWAPLOCAL_CURRENCY_ERROR_UNACCEPTABLE');
	}
}
