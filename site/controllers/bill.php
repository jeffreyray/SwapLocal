...
class SwapLocalControllerBill extends JControllerForm
{
	...
	{
        $this->setRedirect(JRoute::_('index.php?option=com_swaplocal&view=bill&layout=find', false));
	}
	...
	public function search()
	{
        ...
        $this->setRedirect(JRoute::_('index.php?option=com_swaplocal&view=bill&id='.$result->id, false));
	}
	...
	protected function postSaveHook(JModel &$model, $validData = array())
	{
		...
		if ($task == 'save') {
			$this->setRedirect(JRoute::_('index.php?option=com_swaplocal&view=bill&id='.$item->id, false));
		}
	}
