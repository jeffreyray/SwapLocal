 ...
 */
class SwapLocalViewFeatured extends JView
{
	protected $items;
	...
	protected function addToolbar()
	{
		...
		JToolBarHelper::title(JText::_('COM_SWAPLOCAL_FEATURED_TITLE'), 'featured.png');
		...
		JToolBarHelper::help('JHELP_swaplocal_FEATURED_ARTICLES');
	}
}
